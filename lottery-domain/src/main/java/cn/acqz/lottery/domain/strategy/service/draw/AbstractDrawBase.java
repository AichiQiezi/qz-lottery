...
import cn.acqz.lottery.domain.strategy.model.vo.*;
...
public abstract class AbstractDrawBase extends DrawStrategySupport implements IDrawExec {
    ...
    public DrawResult doDrawExec(DrawReq req) {
        ...
        // 3. 获取不再抽奖范围内的列表，包括：奖品库存为空、风控策略、临时调整
    ...
    private void checkAndInitRateData(Long strategyId, Integer strategyMode, List<StrategyDetailBriefVO> strategyDetailList) {
        ...
        for (StrategyDetailBriefVO strategyDetailBriefVO : strategyDetailList) {
            awardRateVOList.add(new AwardRateVO(strategyDetailBriefVO.getAwardId(), strategyDetailBriefVO.getAwardRate()));
        }
