package cn.acqz.lottery.application.mq.consumer;
...
import cn.acqz.lottery.domain.award.service.factory.DistributionGoodsFactory;
...
public class LotteryInvoiceListener {
    ...
    public void onMessage(ConsumerRecord<?, ?> record, Acknowledgment ack, @Header(KafkaHeaders.RECEIVED_TOPIC) String topic) {
        ...
        // 2. 处理 MQ 消息, 在这里可以做幂等性处理 （本质就是在消费前，查看消息是否被消费，难点是这两个操作是存在并发问题的）
        // a. 使用数据库进行唯一键约束
        // b. 消费前设置前置条件
        try {
