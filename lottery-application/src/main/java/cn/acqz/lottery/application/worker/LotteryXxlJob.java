//package cn.acqz.lottery.application.worker;
//
...
//import cn.acqz.lottery.application.process.draw.impl.ActivityDrawProcessImpl;
...
//import cn.acqz.lottery.domain.activity.service.stateflow.IStateHandler;
...
//
//    /**
//     * 扫描并处理状态为 “审核通过”，“活动中” 的抽奖活动
//     * 并判断 “审核通过” 是否可以开始，若可以，修改状态为 活动中
//     * “活动中” 就判断是否结束了，是就修改为结束了
//     * @throws Exception
//     */
